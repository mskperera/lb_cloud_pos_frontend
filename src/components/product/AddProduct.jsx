...
export default function AddProduct({ saveType = SAVE_TYPE.ADD, id = 0 }) {
  ...
  const loadValuesForUpdate = async () => {
    ...
    setBarcode({ ...barcode, value: barcode });
    setSelectedCategories(JSON.parse(categories).map((c) => c.id));
    setMeasurementUnit({ ...measurementUnit, value: measurementUnitId });
    setProductNo({ ...productNo, value: productNo });
    setProductName({ ...productName, value: productName });
    setTaxRatePerc({ ...taxRatePerc, value: taxPerc });
    setUnitCost({ ...unitCost, value: unitCost });
    setUnitPrice({ ...unitPrice, value: unitPrice });
    setBrand({ ...brand, value: brandId });
    setProductType({ ...productType, value: productTypeId });
    setIsExpiringProduct(isExpiringProduct);
    setIsProductItem(isProductItem);
    setIsUnique(isUnique);
    setIsNotForSelling(isNotForSelling);
    setSku({ ...sku, value: sku });
    ...
    if (productTypeId === 1) {
      setReorderLevel({ ...reorderLevel, value: reorderLevel });
      ...
      setReorderLevel({ ...reorderLevel, isDisabled: true });
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-gray-500">{getInstruction("isProductItem")}</p>
              </div>
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  <input
                ...
                <p className="text-xs text-gray-500">{getInstruction("isNotForSelling")}</p>
              </div>
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  <input
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-gray-500">{getInstruction("isStockTracked")}</p>
              </div>
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2">
                  <input
  ...
  <div className="bg-gray-50 p-6 rounded-lg">
    ...
    <div className="flex flex-col md:flex-row md:items-end gap-4 mb-6">
      <div className="flex-1">
        <label className="text-sm font-medium text-gray-700 mb-2 block">Variation Type</label>
    ...
    <div className="overflow-x-auto rounded-md border border-gray-200">
      <table className="w-full border-collapse">
        <thead className="bg-gray-50 text-sm font-medium text-gray-700 border-b border-gray-200">
          <tr>
          ...
          {variations.map((variation, index) => (
            <tr key={variation.variationProductId || index} className="hover:bg-gray-50 transition-colors duration-150">
              <td className="px-4 py-2">
                <input
                  type="text"
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors duration-200 text-sm"
                  value={variation.sku}
                  onChange={(e) => {
...
//             setIsStockTracked((p) => ({ ...p,value:isStockTracked, isDisabled:false }));
...
//         setReorderLevel((p) => ({ ...p, isDisabled:true }));
//            setIsStockTracked((p) => ({ ...p,value:false, isDisabled:true }));
...
//                   <thead className="sticky top-0 bg-base-100 z-10  border-b">
//                     <tr>
...
//                 className="hidden"
//               />
//               <div className="flex items-center justify-center w-40 h-12 btn-primary text-white  font-medium rounded-lgtransition">
//                 Choose File
//               </div>
//             </label>
