...
//     setIsExpiringProduct(false);
//     setIsUnique(false);
//        setIsMultiUom({ value: true, isDisabled: false });
...
// {isMultiUom.value && (
//   <div className="p-3 mb-3 text-sm text-sky-900 bg-sky-50 border border-sky-200 rounded-lg flex items-start gap-2">
//     <span className="font-semibold text-sky-600">ℹ️</span>
//     <div>
//       <p className="font-semibold">Setting the Base Unit:</p>
//       <p className="mt-0.5 text-xs text-sky-800">
//    Select the absolute minimum unit for transactions (e.g., Milligram, Tablet). You will not be able to define or sell units smaller than this Base Unit  </p>
//     </div>
//   </div>
// )}
