...
const validateAll = () => {
  ...
  const states = [cardType,bank,cardNo,cardHolderName,cardExpirationMonth,payAmount];
...
const splitPaymentHandler = () => {
  ...
  onAddPayment({ allValid, fields: {cardTypeId:cardType.value,bankId:bank.value.id,cardNo:cardNo.value,cardHolderName:cardHolderName.value,
    cardExpirationMonth:cardExpirationMonth.value,payAmount: payAmount.value} });
