...
const ReportViewer = ({ reportData, tableHeaders, title, lblLeft, lblRight, tableBottom,injectableComponents, isColumnRemovable=false }) => {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
     ...
     {isColumnRemovable &&   <div className="flex items-center">
        <select
