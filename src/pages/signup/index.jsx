...
// const SignUpPage = () => {
//   const [step, setStep] = useState(1); // 1: form, 2: verify, 3: creating, 4: success
...
//   // Start timer when entering verification step
//   useEffect(() => {
...
//       if (verifyRes?.exception) {
//         setStatus({ type: "error", message: verifyRes.exception.message });
//         return;
//       }
//       if (verifyRes?.error) {
//         setStatus({ type: "error", message: verifyRes.error });
//         return;
//       }
...
//       if (completeRes?.exception) {
//         setStatus({ type: "error", message: completeRes.exception.message });
//         setStep(2);
//         return;
//       }
//       if (completeRes?.error) {
//         setStatus({ type: "error", message: completeRes.error });
//         setStep(2);
//         return;
//       }
...
//       setStatus({
//         type: "success",
//         message: completeRes?.message || "Your Legend POS account has been created!",
//       });
//       setStep(4);
//     } catch (err) {
//       console.error(err);
...
//             <h3 className="text-2xl font-bold text-gray-800">Setting up your POS</h3>
...
//             {/* Content area – full width during step 3 */}
//             <div
//               className={`p-6 lg:p-12 flex flex-col justify-center bg-white transition-all duration-300 ${
//                 step === 3 ? "lg:col-span-2 items-center" : ""
//               }`}
//             >
//               <div
//                 className={`${
//                   step === 3 ? "w-full max-w-3xl" : "max-w-md mx-auto w-full"
//                 }`}
//               >
//                 {/* Only show signup title on step 1 */}
//                 {step === 1 && (
...
//             {/* Marketing Side – hidden during step 3 */}
//             {step !== 3 && (
//               <div className="hidden lg:flex bg-gradient-to-br from-sky-600 to-sky-700 p-8 lg:p-12 text-white flex-col justify-between relative overflow-hidden">
...
//                       alt="Legend POS"
//                       className="h-12 lg:h-14 mx-auto lg:mx-0"
//                     />
//                   </div>

//                   {/* Headline */}
//                   <div className="mb-8 lg:mb-10">
//                     <h2 className="text-4xl lg:text-5xl font-extrabold leading-tight text-center lg:text-left">
//                       Welcome to Legend POS
//                     </h2>
//                   </div>

//                   {/* Tagline + Description + Integrated features with icons */}
//                   <div className="flex flex-col gap-6 lg:gap-8 mb-10 lg:mb-auto">
//                     <p className="text-xl lg:text-2xl font-medium text-blue-100 leading-relaxed text-center lg:text-left">
//                       Simple. Fast. Reliable.
//                     </p>

//                     <p className="text-base lg:text-lg text-blue-50 leading-relaxed max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
//                       Run your entire store using the laptop, PC, or tablet you already own — no
//                       expensive hardware required.
//                     </p>

//                     {/* Two highlighted features with icons */}
//                     <div className="flex flex-col sm:flex-row gap-5 lg:gap-8 justify-center lg:justify-start">
...
//                   {/* Footer */}
//                   <div className="relative z-10 text-center lg:text-left text-sm text-blue-100 mt-auto pt-6 border-t border-white/10">
//                     <div className="flex flex-wrap justify-center lg:justify-start gap-5 lg:gap-6 mb-4">
//                       <Link
//                         to="/privacy"
