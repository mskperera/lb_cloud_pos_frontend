      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 mb-12">
            ...
            >
              Start 1-Month Free Trial – No Card Required
          ...
          <div className="inline-block bg-white/80 backdrop-blur-sm px-8 py-5 rounded-2xl shadow-sm border border-sky-100 mb-16">
            ...
            <p className="mt-3 text-gray-700 font-medium">
              Lock in <span className="text-sky-700 font-bold underline">$10/mo forever</span> when you join now
            </p>
        ...
        {/* Desktop App Area */}
        <div id="desktop" className="mt-12 bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 p-8 md:p-12">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-6">
            One-Click Receipt Printing Like a Traditional POS
          </h2>
          <p className="text-center text-lg text-gray-600 max-w-3xl mx-auto mb-10">
            For lightning-fast billing like a traditional standalone POS, install our free desktop app. It connects seamlessly to your cloud account and your local printers.
          </p>
          ...
          <div className="grid lg:grid-cols-1 gap-8 lg:gap-12 items-center">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-5 mb-6">
                  <img src={windows_icon} alt="Windows" className="w-16 h-16" />
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-3 bg-sky-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-sky-700 transition-colors w-full justify-center text-lg"
                >
              ...
              <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 hover:shadow-lg transition-shadow">
                <div className="flex items-center gap-5 mb-6">
                  <img src={linux_icon} alt="Linux" className="w-16 h-16" />
                  <h3 className="text-2xl font-bold">Linux</h3>
                </div>
                <p className="text-gray-600 mb-6">
                  Compatible with Ubuntu, Fedora, Debian
                </p>
                <a
                  href="#"
                  className="inline-flex items-center gap-3 bg-sky-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-sky-700 transition-colors w-full justify-center text-lg"
    ...
    <section id="features" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div key={i} className="p-8 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-xl transition-shadow">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="bg-gradient-to-br from-sky-600 to-sky-700 text-white rounded-3xl p-10 md:p-16 shadow-2xl">
          ...
          <p className="text-2xl font-bold mt-10 mb-6">
            Lock in $10/month <span className="underline decoration-white/60">forever</span>
          </p>
...
const FAQSection = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "No, use your existing laptop, PC, or tablet. For advanced printing, install our desktop app.",
    },
    {
