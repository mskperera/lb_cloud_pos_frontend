...
//   const discounts = formatCurrency(orderSummary?.discounts || 0);
//   const tax = formatCurrency(orderSummary?.tax || 0);
//   const grandTotal = formatCurrency(orderSummary?.grandTotal || 0);

//   return (
//     <div className="grid p-3" style={{ minHeight: '100px' }}>
//       {/* Subtotal */}
//       <div className="col-12 lg:col-6 p-2">
//         <div className="flex justify-content-between">
//           <span className="text-md font-semibold">Sub Total:</span>
...
//       <div className="col-12 lg:col-6 p-2">
//         <div className="flex justify-content-between">
//           <span className="text-md font-semibold">Discounts:</span>
//           <span className="text-md font-semibold">{discounts}</span>
//         </div>
//       </div>
